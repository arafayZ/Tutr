...
class _ChatDetailsScreenState extends State<ChatDetailsScreen> {
  ...
  Future<void> _fetchTutorProfile() async {
    try {
      final profile = await CourseService.getTutorProfile(widget.studentId, widget.tutorId);

      if (mounted) {
        setState(() {
          _tutorImage = profile['tutorImage']?.toString() ?? '';
          _tutorName = profile['tutorName']?.toString() ?? widget.userName;
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  // Dynamic CircleAvatar with tutor image
                  CircleAvatar(
                    radius: 20,
                    backgroundColor: Colors.black,
                    backgroundImage: _tutorImage.isNotEmpty && !_isLoadingProfile
                  ...
                  Expanded(
                    child: Text(
                      _isLoadingProfile ? widget.userName : _tutorName,
