...
class _MatricScreenState extends State<MatricScreen> {
  ...
  static const String _category = "MATRIC";
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                // Colorful left bar with app icon
                Container(
                  width: 85,
                  decoration: BoxDecoration(
                    color: tutor['color'],
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        // Rating, Teaching Mode, and Location
                        Row(
                          children: [
                            ...
                            // Show actual location if available
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No tutors available for Matric category yet',
            style: TextStyle(
              fontSize: 14,
