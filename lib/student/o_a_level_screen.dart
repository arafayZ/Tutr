...
class _OALevelScreenState extends State<OALevelScreen> {
  ...
  // Fetch BOTH O Level and A Level courses
  static const List<String> _categories = ["O_LEVEL", "A_LEVEL"];
  ...
  Future<void> _loadTutors() async {
    ...
    try {
      ...
      // Fetch courses for both O Level and A Level
      for (String category in _categories) {
        ...
        final List<Map<String, dynamic>> transformedTutors = _transformApiResponse(response, category);
        allResults.addAll(transformedTutors);
      }

      setState(() {
        allTutors = allResults;
        _applyFilters();
        _isLoading = false;
      });
    } catch (e) {
  ...
  List<Map<String, dynamic>> _transformApiResponse(List<dynamic> courses, String category) {
    return courses.map((course) {
      ...
      String categoryDisplay = category == 'O_LEVEL' ? 'O Level' : 'A Level';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: tutor['category'] == 'O Level' ? Colors.blue.shade100 : Colors.green.shade100,
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 10,
                              fontWeight: FontWeight.bold,
                              color: tutor['category'] == 'O Level' ? Colors.blue.shade800 : Colors.green.shade800,
                            ),
                          ),
                        ),
                        const SizedBox(height: 2),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No tutors available for O & A Level category yet',
            style: TextStyle(
              fontSize: 14,
